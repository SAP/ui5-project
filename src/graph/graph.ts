 ...
 * @param [options.versionOverride] Framework version to use instead of the one defined in the root project
 * @param [options.resolveFrameworkDependencies]
 ...
 *
 * @param options
 * @param [options.filePath] Path to the dependency configuration file
 * @param [options.cwd] Directory to resolve relative paths to
 * @param [options.rootConfiguration]
 *		Configuration object to use for the root module instead of reading from a configuration file
 * @param [options.rootConfigPath]
 *		Configuration file to use for the root module instead the default ui5.yaml. Either a path relative to
