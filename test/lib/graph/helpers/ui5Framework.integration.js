...
1. Failed to resolve library sap.ui.lib1:
Failed to extract package @sapui5/distribution-metadata@1.75.0: 404 - @sapui5/distribution-metadata

2. Failed to resolve library sap.ui.lib4:
See error logged above ("Failed to extract package @sap...")`
});
defineErrorTest("SAPUI5: ui5Framework helper should throw a proper error when package extraction fails", {
	...
	expectedErrorMessage: `Resolution of framework libraries failed with errors:
1. Failed to resolve library sap.ui.lib1:
Failed to extract package @sapui5/sap.ui.lib1@1.75.1: 404 - @sapui5/sap.ui.lib1

2. Failed to resolve library sap.ui.lib4:
Failed to extract package @openui5/sap.ui.lib4@1.75.4: 404 - @openui5/sap.ui.lib4`
});
defineErrorTest(
...
defineErrorTest("OpenUI5: ui5Framework helper should throw a proper error when metadata request fails", {
	...
	expectedErrorMessage: `Resolution of framework libraries failed with errors:
1. Failed to resolve library sap.ui.lib1:
Failed to read manifest of @openui5/sap.ui.lib1@1.75.0

2. Failed to resolve library sap.ui.lib4:
Failed to read manifest of @openui5/sap.ui.lib4@1.75.0`
});
defineErrorTest("OpenUI5: ui5Framework helper should throw a proper error when package extraction fails", {
	...
	expectedErrorMessage: `Resolution of framework libraries failed with errors:
1. Failed to resolve library sap.ui.lib1:
Failed to extract package @openui5/sap.ui.lib1@1.75.0: ` +
`404 - @openui5/sap.ui.lib1

2. Failed to resolve library sap.ui.lib4:
Failed to extract package @openui5/sap.ui.lib4@1.75.0: ` +
...
test.serial(
	...
	async (t) => {
		...
		await t.throwsAsync(async () => {
			...
			message: `Failed to resolve library does.not.exist:\nCould not find library "does.not.exist"`});
	});
