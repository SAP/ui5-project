...
test.serial("ui5Framework translator should enhance tree with UI5 framework libraries", async (t) => {
	...
	sinon.stub(projectPreprocessor.ProjectPreprocessor.prototype, "readConfigFile")
		...
		.withArgs(path.join(ui5PackagesBaseDir, "@openui5", "sap.ui.lib1", "1.75.1", "ui5.yaml"))
		.resolves([{
			specVersion: "1.0",
			type: "library",
			metadata: {
		...
		.withArgs(path.join(ui5PackagesBaseDir, "@openui5", "sap.ui.lib2", "1.75.2", "ui5.yaml"))
		.resolves([{
			specVersion: "1.0",
			type: "library",
			metadata: {
		...
		.withArgs(path.join(ui5PackagesBaseDir, "@openui5", "sap.ui.lib3", "1.75.3", "ui5.yaml"))
		.resolves([{
			specVersion: "1.0",
			type: "library",
			metadata: {
		...
		dependencies: [
			{
				...
				dependencies: [
					...
					},
					{
						...
						version: "1.75.2",
						path: path.join(ui5PackagesBaseDir, "@openui5", "sap.ui.lib2", "1.75.2"),
						specVersion: "1.0",
						kind: "project",
						type: "library",
						metadata: {
						...
						dependencies: [
							{
								...
								version: "1.75.3",
								path: path.join(ui5PackagesBaseDir, "@openui5", "sap.ui.lib3", "1.75.3"),
								specVersion: "1.0",
								kind: "project",
								type: "library",
								metadata: {
