...
Error installing sap.ui.lib1

2. Failed to resolve library sap.ui.lib2:
Error installing sap.ui.lib2`});
...
test("AbstractResolver: install error handling (rejection of dependency metadata/install)", async (t) => {
	...
	}, {message: `Failed to resolve library sap.ui.lib2:
Error installing sap.ui.lib2`});
...
test("AbstractResolver: install error handling (rejection of dependency install)", async (t) => {
	...
	await t.throwsAsync(async () => {
		await resolver.install(["sap.ui.lib1"]);
	}, {message: `Failed to resolve library sap.ui.lib3:
Error installing sap.ui.lib3`});
...
1. Failed to resolve library sap.ui.lib1:
Error within handleLibrary: sap.ui.lib1

2. Failed to resolve library sap.ui.lib2:
Error within handleLibrary: sap.ui.lib2`});
