...
test("specVersion: Project with valid version 2.4", async (t) => {
	const tree = {
		id: "application.a",
		path: applicationAPath,
		dependencies: [],
	...
	const res = await projectPreprocessor.processTree(tree);
	t.deepEqual(res.specVersion, "2.4", "Correct spec version");
});

test("specVersion: Project with valid version 2.5", async (t) => {
	const tree = {
		id: "application.a",
		path: applicationAPath,
		dependencies: [],
	...
	const res = await projectPreprocessor.processTree(tree);
	t.deepEqual(res.specVersion, "2.5", "Correct spec version");
});

test("specVersion: Project with valid version 2.6", async (t) => {
	const tree = {
		id: "application.a",
		path: applicationAPath,
		dependencies: [],
	...
	const res = await projectPreprocessor.processTree(tree);
	t.deepEqual(res.specVersion, "2.6", "Correct spec version");
});
