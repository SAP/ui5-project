...
module.exports = async function({
	...
	log.verbose(`  Including dependencies: ${buildDependencies}`);

	const buildParams = {dev, selfContained, jsdoc, includedTasks, excludedTasks};
	...
	try {
		...
		await graph.traverseDepthFirst(async function({project, getDependencies}) {
			...
			// let targetReader;
			// if (projectContext.isRootProject() && project.getType() === "application") {
			// 	targetReader = project.getReader({
			// 		style: "flat"
			// 	});
			// } else {
			// 	targetReader = project.getReader({
