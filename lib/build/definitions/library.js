...
import {enhanceBundleDefinitionWithDefaults} from "../../validation/validator.js";
				...
				return bundles.reduce(function(sequence, bundle) {
					return sequence.then(async function() {
						return generateBundleTask.task({
							...
							options: {
								projectName: options.projectName,
								bundleDefinition: await enhanceBundleDefinitionWithDefaults(bundle.bundleDefinition, taskUtil.getProject()),
