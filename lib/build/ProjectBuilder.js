...
class ProjectBuilder {
	...
	/**
	 * Alternatively to providing plain lists of dependency names to include and exclude, a more complex
	 * "Dependency Includes" object can be provided to define which dependencies should be part of the build result.
	 * <br>
	 * The provided information will be used to compile lists of <code>includedDependencies</code> and
	 * <code>excludedDependencies</code>, which will be used during the build process.
	 * <br><br>
	 ...
	 * dependency-includes are appended in the end.
	 * <br><br>
	 * The priority of the various dependency lists is applied in the following order.
	 * But note that a later exclude can't overrule an earlier include:
	 * <br>
	 * <ol>
	 ...
	 * @property {object} parameters Complex dependency includes
	 * @property {boolean} parameters.includeAllDependencies
	 ...
	 * @property {string[]} parameters.includeDependency
	 ...
	 * @property {string[]} parameters.includeDependencyRegExp
