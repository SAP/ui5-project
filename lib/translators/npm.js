...
const resolveModulePath = promisify(require("enhanced-resolve"));
...
class NpmTranslator {
	...
	*/
	findModulePath(basePath, moduleName) {
		// TODO what about preserveSymlinks: false ?
		return resolveModulePath(basePath, moduleName + "/package.json").then((pkgPath) => {
