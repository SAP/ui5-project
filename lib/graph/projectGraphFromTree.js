 ...
 * @property {string} [node.configuration] Configuration object to use instead of reading from a configuration file
 ...
 * @param {module:@ui5/project.graph.ProjectGraph} [projectGraph] Project graph to use instead of creating a new one
 * @returns {Promise<module:@ui5/project.graph.ProjectGraph>} A project graph instance
 */
module.exports = async function(tree, projectGraph) {
