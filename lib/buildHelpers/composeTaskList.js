 ...
 * @param {boolean} parameters.archive True if an archive build should be executed
 ...
 */
module.exports = function composeTaskList(allTasks, {selfContained, jsdoc, archive, includedTasks, excludedTasks}) {
