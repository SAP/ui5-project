 ...
 * @extends module:@ui5/project.specifications.Specification
 */
class Project extends Specification {
	...
	*/
	 ...
	 * @returns {Promise<module:@ui5/fs.ReaderCollection>} Reader collection allowing access to all resources of the
	 *                                                     project
	 */
	async getReader(options) {
	...
	*
	* @public
	* @returns {Promise<module:@ui5/fs.DuplexCollection>} DuplexCollection
	*/
	async getWorkspace() {
