...
class Project extends Specification {
	...
	getReader({style = "buildtime"} = {}) {
		...
		// 	readers
		// });
		reader = this.getReaderForVersion(this.getCurrentResourceVersion(), style);
	...
	*/
	getWorkspace() {
		...
		this.#latestWorkspace = createWorkspace({
			reader: this.getReaderForVersion(this.getCurrentResourceVersion()),
