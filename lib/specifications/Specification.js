...
class Specification {
	 ...
	 */
	async init({id, version, modulePath, configuration, buildDescription}) {
		if (!id) {
		...
		await this._parseConfiguration(config, buildDescription);
		this._config = config;
		return this;
	}
	...
	*/
	...
	static async create(params) {
		...
		case "legacy-library": {
			return createAndInitializeSpec("LegacyLibrary", params);
		}
		case "theme-library": {
