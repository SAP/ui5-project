...
class Installer {
	...
	async fetchPackageManifest({pkgName, version = this._version, targetDir = this._getTargetDirForPackage({pkgName, version})}) {
		try {
	...
	async installPackage({pkgName, version, targetDir = this._getTargetDirForPackage({pkgName, version})}) {
		try {
