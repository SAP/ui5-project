...
const log = logger.getLogger("ui5Framework:Sapui5Resolver");

const DIST_PKG_NAME = "@sapui5/distribution-metadata";

/**
 * @module @ui5/project/ui5Framework/Sapui5Resolver
 * @public
 */
/**
 ...
 */
export default class Sapui5Resolver extends AbstractResolver {
	/**
